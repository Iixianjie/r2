...
var signModel = (function (model, namespace) {
  ...
  if (reducers) {
    ...
    for (var _i = 0, _Object$entries = Object.entries(reducers); _i < _Object$entries.length; _i++) {
      ...
      if (!isFunction(reducer)) throw Error("".concat(namespace, ".reducers.").concat(reducerKey, " must be function"));
  ...
  if (effects) {
    ...
    for (var _i2 = 0, _Object$entries2 = Object.entries(effects); _i2 < _Object$entries2.length; _i2++) {
      ...
      if (!isFunction(_reducer)) throw Error("".concat(effects, ".reducers.").concat(_reducerKey, " must be function"));
  ...
  return function (next) {
    return function (action, payload) {
      ...
      if (patchType === 'reducer') {
        next({
          type: type,
          __localState: _defineProperty$1({}, namespace, action(modelState, payload)),
          __fnReducer: true
        });
        return;
      }
  ...
  return function (reducer, preloadedState) {
    function coreReducer(rootState, action) {
      ...
      if (payload.__fnReducer) {
        return _objectSpread2$1({}, rootState, {}, payload.__localState);
      }
      ...
      if (type === 'replaceRootState') {
        ...
        return _objectSpread2$1({}, rootState, {}, payload);
      }
      ...
      if (setStateMatch.test(type)) {
        ...
        return _objectSpread2$1({}, rootState, _defineProperty$1({}, namespace, _objectSpread2$1({}, payload)));
      }
...
var createStoreEnhance = function createStoreEnhance(_ref) {
  ...
  var enhanceSpread = [applyMiddleware(coreMiddleware), coreEnhance];
  ...
  return createStore(App, initState, enhances);
}; // const store = createStoreEnhance<rootState>({

module.exports = createStoreEnhance;
